...
public class FormularioEditarMascota extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Modificación de Datos");

        btnAplicarCambios.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
            ...
            .addGroup(panelFondoLayout.createSequentialGroup()
                .addGroup(panelFondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelFondoLayout.createSequentialGroup()
                        ...
                        .addGap(29, 29, 29)
                        .addComponent(btnAplicarCambios, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(panelFondoLayout.createSequentialGroup()
                        .addGap(427, 427, 427)
        ...
        panelFondoLayout.setVerticalGroup(
            ...
            .addGroup(panelFondoLayout.createSequentialGroup()
                ...
                .addGroup(panelFondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnAplicarCambios, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnAplicarCambiosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAplicarCambiosActionPerformed
        ...
        try {
            //Editar dueño
            _controladoraServicios.editarDuenio(
                    _mascota.getDuenio(), 
                    txtNombreDuenio.getText(), 
                    txtTelefonoDuenio.getText());
            
            //Editar mascota
            _controladoraServicios.editarMascota(
                    _mascota,
            ...
            Logger.getLogger(FormularioEditarMascota.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void establecerDatos(){ 
        ...
        txtNombreMascota.setText(_mascota.getNombre());
        txtRaza.setText(_mascota.getRaza());
        txtColorMascota.setText(_mascota.getColor());
